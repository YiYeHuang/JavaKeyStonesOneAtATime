...
@StringTag
@Hard
public class ReadNCharactersGivenRead4II_multiCall extends Reader4 {
    ...
    public int read(char[] buf, int n) {
        ...
        while (ptr4 < n) {
            ...
            while (ptr4 < n && bufferPtr < buffCounter) {
                buf4[ptr4++] = buf[bufferPtr++];
            }
            if (bufferPtr >= buffCounter) bufferPtr = 0;
        }
